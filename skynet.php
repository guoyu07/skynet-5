...
/* Skynet Standalone | version compiled: 2017.04.19 01:20:27 (1492564827) */
  ...
  public function broadcast()
  {
    ...
    if(is_array($clusters) && count($clusters) > 0)
    {
      foreach($clusters as $cluster)
      {
        ...
        /* Prepare address */
        $address = SkynetConfig::get('core_connection_protocol').$cluster->getUrl();
  ...
  */
  public function connect($remote_cluster = null, $chain = null)
  {
    ...
    try
    {
      ...
      if(!$this->isBroadcast)
      {
        $clusterAddress = str_replace(array(SkynetConfig::get('core_connection_protocol'), 'http://', 'https://'), '', $this->clusterUrl);
...
{  
  ...
  */   
  ...
  {   
    ...
    $ary['_skynet_id'] = SkynetConfig::KEY_ID;
...
class SkynetEventListenerLoggerDatabase extends SkynetEventListenerAbstract implements SkynetEventListenerInterface
{
  ...
  */
  public function onRequest($context = null)
  {
    if(SkynetConfig::get('logs_db_requests')) 
    {
  ...
  */
  public function onResponse($context = null)
  {
    if(SkynetConfig::get('logs_db_responses')) 
    {
